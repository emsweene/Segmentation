...
Rscript OASIS_run1.R  'FLAIRnorm.nii.gz' 'PDnorm.nii.gz' 'T2norm.nii.gz' 'T1norm.nii.gz' 'csfmask.nii.gz' 'FLAIR_blur1_10_div.nii.gz' 
'FLAIR_blur1_20_div.nii.gz' 'PD_blur1_10_div.nii.gz' 'PD_blur1_20_div.nii.gz' 'T2_blur1_10_div.nii.gz' 'T2_blur1_20_div.nii.gz' '
T1_blur1_10_div.nii.gz' 'T1_blur1_20_div.nii.gz'  
