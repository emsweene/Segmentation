...
# regression after voxel selection masks  have been made and applied to the brain.  
# 
#
# Elizabeth Sweeney
# November 1, 2011
...
##This function selects candidate voxels for modeling##
...
blur_10_dir <- c('/nexsan/bst5/msmri/Hopkins_MRI/Navid_Data/Elizabeth_Processed_MS_Data/OASIS_RePro/BLUR_1/divided/10/')
blur_20_dir <- c('/nexsan/bst5/msmri/Hopkins_MRI/Navid_Data/Elizabeth_Processed_MS_Data/OASIS_RePro/BLUR_1/divided/20/')
...
#####################################################################################################################
# Reads in the data, creates and applies voxel selection masks to images
#####################################################################################################################
...
#####################################################################################################################
##determine threshold for probability maps from the trianing set
#####################################################################################################################
...
save.image('valid_set_1_training')
...
######################################################################################################################
## Make partialROC curves
######################################################################################################################


pdf('pROC_OASIS_training_1.pdf')
...
##determine thershold for first segmentation from the ROC analysis##

movie_alpha <- ##enter value for first threshold here##


setwd('/nexsan/bst5/msmri/Hopkins_MRI/Navid_Data/Elizabeth_Processed_MS_Data/OASIS_RePro/OASIS_SEG_1/')
...
#####################################################################################################################
	...
	topvoxels <- candidate_voxels_one_modal(3, .90 , dura_mask, flair)
...
#####################################################################################################################
    ...
    filename <- paste(patient_id, "segment" , sep = "_")
	f.write.nifti(prob_map, filename ,size="float",nii=TRUE)
